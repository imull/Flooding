...
#Part One
#Imporing Arcpy, OS and Setting the enviroment
Import arcpy
Import os
...
Project_management (in_dataset = ________, out_dataset = _______\reproject , out_coor_system = ‘32119’, transform_method = ______, ….) 

+ transform_method? FEATURES

# Project a raster: ProjectRaster_management (in_raster, out_raster, out_coor_system, {resampling_type}, {cell_size}, {geographic_transform}, {Registration_Point}, {in_coor_system}, {vertical})
